...
/*                                                   +#+                      */
/*   Created: 2020/03/11 18:15:25 by mramadan      #+#    #+#                 */
/*   Updated: 2020/04/15 12:13:22 by Marty         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	sprite_side_1_up_right(t_vars *v)
{
	...
	i = (v->s[v->spr].all_x - v->s[v->spr].hitx) /
	(v->s[v->spr].incr_ray + v->s[v->spr].incr_spr);
